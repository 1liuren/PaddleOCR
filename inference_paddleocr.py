...
# model = TextRecognition(model_name="PP-OCRv5_server_rec", model_dir="PP-OCRv5_server_rec_Tibetan_openpecha_infer")
model = TextRecognition(model_name="PP-OCRv5_server_rec", model_dir="PP-OCRv5_server_rec_infer_openpecha_ch_en")

output = model.predict(input=r"pdf_ocr\test_images\000007269.png", batch_size=1)
for res in output:
    res.print()
